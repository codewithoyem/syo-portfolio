...
import { ArrowRight, Video, ChevronLeft, ChevronRight, Send, Github, Linkedin, Twitter, CheckCircle, Loader2 } from 'lucide-react';
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-800">
                ...
                <div className="flex items-center gap-4">
                  {[<Github size={20} />, <Linkedin size={20} />, <Twitter size={20} />].map((icon, i) => (
                    <a key={i} href="#" className="p-3 rounded-full bg-surface-dark border border-gray-700 hover:border-primary hover:text-primary hover:shadow-[0_0_15px_rgba(0,204,255,0.2)] transition-all text-gray-400">
                      {icon}
                    </a>
                  ))}
                </div>
