...
export const Home: React.FC = () => {
  return (
    <div className={`relative z-10 flex-grow flex flex-col justify-center pt-24 pb-12 px-4 md:px-8  bg-[url(${sundayOlanisimi})] bg-no-repeat bg-top bg-cover md:bg-contain`}>
